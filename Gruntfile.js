// Generated on 2014-05-04 using generator-ionic 0.2.10
'use strict';
    ...
    grunt.initConfig({
        ...
        'notify_hooks': {
            options: {
                ...
                title: 'Pocket' // defaults to the name in package.json, or will use project directory's name
            }
        },
        ...
        karma: {
            options: {
                ...
                files: [
                    ...
                    '<%= yeoman.app %>/bower_components/restangular/src/restangular.js',
